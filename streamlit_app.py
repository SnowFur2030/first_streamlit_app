...
def get_fruityvice_data(this_fruit_choice):
  ...
  fruityvice_normalized = pandas.json_normalize(fruityvice_response.json()) # removes the data formating
  return fruityvice_normalized # puts the data into a table
...
def insert_row_snowflake(new_fruit):
  with my_cnx.cursor() as my_cur:
    ...
    returm "Thanks for adding " + new_fruit
